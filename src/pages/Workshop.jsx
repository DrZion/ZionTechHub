          ...
          <motion.div
            ...
            <div className=" flex flex-col gap-[24px]">
              ...
              <h1 className=" text-[#1A1A1A] font-[700] sm:text-[64px] text-[40px] sm:w-full w-[320px] sm:leading-[130%] sm:tracker-[1.28px] leading-[120%] tracker-[0.8px]">
                Topic:{" "}
                <span className=" text-[#034FE3]">The Evolving Role of Data Analytics: Trends, Tools and Tomorrow</span>
              </h1>
              <p className=" text-[#1A1A1A] font-[300] sm:text-[24px] text-[18px] sm:w-[712px] w-[325px]">
                The traditional data analyst role, centered around Excel, Power BI, and SQL is rapidly transforming. 

Leading companies like TikTok Netflix,  Amazon and Cowrywise are now demanding more: ETL expertise, predictive analytics, and model deployment are becoming the new standard.

This weekend, I’m hosting Akshay Raj Pallerla, a Data Engineer at TikTok, as we unpack this transformation and what it means for your career
              </p>
            </div>
